...
export function FieldMappingSetupView() {
  function handleStartMapping() {
    // Mock action — no backend yet
    console.info("Start Mapping clicked");
  }

  return (
    <div className="flex min-h-[calc(100vh-4rem)] flex-col">
      <div className="flex flex-1 flex-col gap-6 overflow-auto p-4 md:p-8">
        <div className="grid h-full min-h-[420px] grid-cols-1 gap-6 lg:grid-cols-2">
      ...
      <footer className="sticky bottom-0 z-40 flex items-center justify-end border-t border-outline-variant bg-surface/80 px-4 py-4 shadow-sm backdrop-blur-md md:px-6">
        <Button
          type="button"
